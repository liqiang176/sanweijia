...
class ApiAutoLog():
    ...
    def __new__(cls, *args, **kwargs):
        ...
        # sink = "../logs/{}.log".format(log_name)  # 日志记录文件路径
        ...
        # )
        logger.add("../logs/test_{time}.log", format="{time:YYYY-MM-DD HH:mm:ss} | {level} | {name} | {line} | {message}", encoding="utf-8", enqueue=True, rotation="500MB", retention="1 week")
        return logger
